...
public class AndroidOAuth2Controller {
    ...
    public void androidOAuth2Callback(Authentication authentication, HttpServletResponse response) throws IOException {
        ...
        // Android login isn't part of the OAuth2 Authorization Server's /oauth2/token flow,
        // so there is no RegisteredClient to attach to an OAuth2TokenContext here
        // (JwtGenerator requires one); generate the JWT directly instead.
