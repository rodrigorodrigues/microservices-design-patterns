  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="spendingbetterApp.category.delete.question">
          <Translate contentKey="spendingbetterApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
